...
function Section3() {
    ...
    return (
        <div className={`flex justify-between items-center ${sectionClasses}`}>
            <h1 className="text-xl font-medium">Section 3 Content</h1>
            <h1 className="text-lg font-mono px-3 py-1 rounded-full bg-red-500 text-white">
                Theme: {theme}
            </h1>
        </div>
    )
